    ...
    <aside className={styles.contacts}>
      ...
      <a href='mailto:youremailaddress'>
        ...
        >
          <g fill='#030104'>
            ...
            <path d='M13.684 2.271C13.504 2.103 13.262 2 12.993 2H1.007C.74 2 .498 2.104.318 2.273L7 8 13.684 2.271zM0 2.878L0 11.186 4.833 7.079zM9.167 7.079L14 11.186 14 2.875z' />
          </g>
        </svg>
      ...
      <p>
        ...
        >
          ...
          <path d='M267.75 127.5L229.5 127.5 229.5 280.5 362.1 362.1 382.5 328.95 267.75 260.1z' />
        </svg>
        Mon - Fri: 9 - 5, Sat 9 - 2
      </p>
    </aside>
